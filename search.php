...
if(isset($_GET["search"])){
    $posts = $getFromP->searchPosts($_GET["search"]);
}
                    ...
                    foreach($posts as $post){
                        ...
                        if($post["type"] === "audio"){
                            ...
                            if( $userData->user_id != $_SESSION["user_id"] ) {
                                $tip_button = '<div class="send-tip-button"  data-id-post="'.$post["post_id"].'" data-id-user="'.$userData->user_id.'">
                    ...
                    $.ajax({
                        ...
                        success: function (data){
                            if(data != "error"){
                                ...
                                swal("Donated", "Thank you for supporting artists", "success");
                            }else{
                                swal("Error", "You don't enough money", "error");
                            }                      
                        },
                        error: function(err){
